...
const BookFilter: React.FC<Props> = ({ books, onChange }) => {
    ...
    const itemClasses = {
        base: "py-0 w-full",
        trigger: "py-0 cursor-pointer rounded-lg h-12 flex items-center",
        ...
        <div className="w-full max-w-[313px] sticky top-1">
            <div className="bg-white p-4 rounded-2xl shadow flex flex-col gap-4">
                ...
                <Accordion
                    ...
                    variant="light">
                    <AccordionItem value="categories" title="دسته‌بندی" startContent={<LuFolderOpenDot className="text-2xl" />}>
                ...
                <Button onPress={clearFilters} variant="flat">
                    پاک سازی
                </Button>
            </div>
        </div>
