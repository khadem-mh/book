...
export default function BookCard({ book }: BookCardProps) {
  ...
  return (
    <Link href={`/books/${book.slug}`}>
      <div className="bg-white shadow-[0_0_10px_#e5e5e5] hover:shadow-none border border-slate-200 transition-shadow duration-500 hover:animate-appearance-in rounded-2xl lg:p-2 xl:p-4 flex flex-col gap-4 items-center">
        <div className='w-full flex flex-col xl:flex-row items-center justify-center'>
          ...
          <div className="flex xl:flex-col floating-box xl:gap-4 mt-4 xl:mt-0 xl:border border-r-0 border-slate-200 rounded-l-2xl rounded-r-0 py-4 text-sm">
            {/** سال انتشار */}
            ...
            {/** تعداد صفحات */}
            <div className="flex-1 border-r border-l xl:border-0 border-slate-200 min-w-28 w-fit h-fit flex flex-col items-center">
        ...
        <div className="flex flex-col flex-1 -mt-4 xl:mt-0 text-right rounded-2xl p-4">
